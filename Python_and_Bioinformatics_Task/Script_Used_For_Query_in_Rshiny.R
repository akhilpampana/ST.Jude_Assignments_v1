...
## Created UI with buttons to query for the mapping
ui <- fluidPage(
...
## Server script containing code for querying information based on getBM. Please do install all the pacakges promted above for smooth flow. Also please refer to rshiny app for query in the documentation. 
